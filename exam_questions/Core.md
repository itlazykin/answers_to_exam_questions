...
JVM (Java Virtual Machine) — это виртуальная машина, которая обеспечивает выполнение Java-программ, 
абстрагируясь от конкретной аппаратной и операционной среды. Это ключевая часть Java Runtime Environment (JRE).
