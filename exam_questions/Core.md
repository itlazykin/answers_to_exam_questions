...
JVM (Java Virtual Machine) — это специальная программа, которая позволяет запускать Java-программы на любом устройстве
или операционной системе. Основная идея заключается в том, что Java-программа компилируется не в машинный код конкретной
платформы, а в специальный промежуточный код, называемый байт-кодом, который затем выполняется JVM.

[К оглавлению](#Core)

## 2. К какому типу языка программирования относится Java? Что такое исходный код? Что такое байт-код?

Java — строго типизированный объектно-ориентированный язык программирования, разработанный компанией Sun Microsystems(далее приобретённой Oracle). Каждая переменная и константа представляет определенный тип, который строго определен. Тип
...
Исходный код - это текст компьютерной программы, написанный на понятном человеку языке программирования. Исходный код
содержит инструкции, которые объясняют компьютеру, что необходимо делать. Исходные коды представляют собой текстовые
файлы с расширением .java (для Java).

Байт-код - это исполняемый код, который генерируется из исходного кода программы. Это низкоуровневый код, который
понимает и может выполнять виртуальная машина. Байт-код обычно более компактный и эффективный по сравнению с исходным
кодом. Он не читается человеком, но может быть обработан и выполнен компьютером.
Байт-код преобразуется в машинный код (последовательность нулей и единиц, которую компьютер может выполнить) виртуальной
машиной. Например, Java-приложения выполняются с помощью виртуальной машины Java (JVM), которая сначала преобразует
байт-код в машинный код для конкретного процессора.
...
JDK (Java Development Kit) - Это набор программ, утилит и документации необходимый для разработки программ на языке
Java. Включающий компилятор Java (javac), стандартные
...
Это минимальная реализация виртуальной машины, необходимая для исполнения Java-приложений, без компилятора и других
средств разработки.
...
VM (Java Virtual Machine) - это ключевая часть платформы Java, обеспечивающая выполнение Java-программ независимо от
