...
значения после инициализации (константы). Это ограничение существует для предотвращения возможных ошибок,
связанных с изменением переменных, используемых внутри лямбда-выражений,
которые могут выполняться в другом потоке или позже.
