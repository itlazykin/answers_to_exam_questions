...
Лямбда-выражение (или lambda-выражение) — это компактный способ представления анонимной функции в Java. Оно было введено в Java 8 и позволяет выразить функциональность более лаконично, особенно при работе с функциональными интерфейсами. Лямбда-выражение — это блок кода, который можно передать и выполнить в другом месте.
